 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\IPython\\core\\interactiveshell.py:3146: DtypeWarning: Columns (70,71,72,73,74,76,79) have mixed types.Specify dtype option on import or set low_memory=False.\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:1: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  \"\"\"Entry point for launching an IPython kernel.\n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:2: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  \n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:4: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  after removing the cwd from sys.path.\n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:6: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  \n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:8: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  \n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:10: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  # Remove the CWD from sys.path while we load stuff.\n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:12: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  if sys.path[0] == '':\n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:14: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  \n",
      "c:\\users\\xico2\\appdata\\local\\programs\\python\\python37-32\\lib\\site-packages\\ipykernel_launcher.py:16: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    print('Welcome to our analysis, where we help you make your own decision based on facts CO2 Emissions per Country and Car!')\n",
    "    print('\\n')\n",
    ...
    "                co2emission=(cars2018_c[\"co2_per_km\"][cars2018_c[\"model_full\"]==model]).mean() #gives an answer in GRAM of co2 per KILOÑEMETER\n",
    "                co2values.append(co2emission)\n",
    "            else :\n",
    "                oil_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Oil Sources %\"].iloc[0]/100\n",
    "                nuclear_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Nuclear Sources %\"].iloc[0]/100\n",
    "                coal_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Coal Sources %\"].iloc[0]/100\n",
    "                naturalgas_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Natural Gas Sources %\"].iloc[0]/100\n",
    "                Hydro_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Hydroelectric Sources %\"].iloc[0]/100\n",
    "                Renew_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Renewable Sources %\"].iloc[0]/100\n",
    "                rest_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"rest\"].iloc[0]/100\n",
    "                \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "#model = \"Cherokee FWD\"\n",
    "#elec_car = \"Tesla\"\n",
    "#model_e = \"Model 3 Mid Range\"\n",
    "#\n",
    "#\n",
    "#\n",
    "#\n",
    "#\n",
    "#co2emission=(cars2018_c[\"co2_per_km\"][cars2018_c[\"model\"]==model]).mean() #gives an answer in GRAM of co2 per KILOÑEMETER\n",
    "#\n",
    "##now lets calculate co2 for electric cars .. :)   \n",
    "#\n",
    "#oil_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Oil Sources %\"].iloc[0]/100\n",
    "#nuclear_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Nuclear Sources %\"].iloc[0]/100\n",
    "#coal_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Coal Sources %\"].iloc[0]/100\n",
    ...
    "#\n",
    "#if habits == \"city\":\n",
    "#    kwhperkm= (cars2018_c[\"cityE_100km\"][cars2018_c[\"model\"]==model_e]/100).mean()\n",
    "#    co2emission_elec = kwhperkm*coal_source*coal_prod + kwhperkm*oil_source*oil_prod + kwhperkm*nuclear_prod*nuclear_source + kwhperkm*natural_gas_prod*naturalgas_source + kwhperkm*renewable_prod*Renew_source +kwhperkm*hydroelectric_prod*Hydro_source\n",
    "#    co2emission_elec += rest_source*co2emission_elec\n",
    "#    co2emission_elec_inclbatt=co2emission_elec + 52 #calculation explained in documents attached: battery co2\n",
    "#\n",
    "#if habits == \"highway\":\n",
    "#    kwhperkm= (cars2018_c[\"highwayE_per_km\"][cars2018_c[\"model\"]==model_e]/100).mean()\n",
    "#    co2emission_elec = kwhperkm*coal_source*coal_prod + kwhperkm*oil_source*oil_prod + kwhperkm*nuclear_prod*nuclear_source + kwhperkm*natural_gas_prod*naturalgas_source + kwhperkm*renewable_prod*Renew_source +kwhperkm*hydroelectric_prod*Hydro_source\n",
    "#    co2emission_elec += rest_source*co2emission_elec\n",
    "#    co2emission_elec_inclbatt=co2emission_elec + 52\n",
    "#\n",
    "#if habits == \"combined\":\n",
    "#    kwhperkm= (cars2018_c[\"combE_per_km\"][cars2018_c[\"model\"]==model_e]/100).mean()\n",
    "#    co2emission_elec = kwhperkm*coal_source*coal_prod + kwhperkm*oil_source*oil_prod + kwhperkm*nuclear_prod*nuclear_source + kwhperkm*natural_gas_prod*naturalgas_source + kwhperkm*renewable_prod*Renew_source +kwhperkm*hydroelectric_prod*Hydro_source\n",
    "#    co2emission_elec += rest_source*co2emission_elec\n",
    "#    co2emission_elec_inclbatt=co2emission_elec + 52  \n",
    "#    \n",
    "#    list_values.append(co2emission_elec_inclbatt)\n",
    "#    \n",
    "##result_list= []\n",
    "##columnsname = [sdkdfhsak]\n",
    "##result_lists.append(co2emission)\n",
    "##result_lists.append(co2emission_elec_inclbatt)\n",
    "#\n",
    "#\n",
    "#df_car = pd.DataFrame(list(dict_car.items()),columns = [country_1,country_2, country_3])\n",
    "#print(co2emission)\n",
    "#print(co2emission_elec_inclbatt)  "
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "#country=\"Belgium\"\n",
    "#oil_source = table_elec_source_breakdown[table_elec_source_breakdown[\"Country\"]==country][\"Oil Sources %\"]/100\n",
    "#oil_source"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "#kwhperkm= (cars2018_c[\"City_kwh_100km\"][cars2018_c[\"model\"]==model_e]/100).mean()\n",
    "#kwhperkm"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "#cars2018_c[\"fuelType\"][cars2018_c[\"model_full\"]==\"Tesla Model S 75D\"]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "\n",
      "\n",
      "Pick a country for analysis?Portugal\n",
      "Do you want to pick another country?(Y) or (N)Y\n",
      "Pick another country?France\n",
      "Do you want to pick another country?(Y) or (N)Y\n",
      "Pick another country?Germany\n",
      "Where do you usally drive? City, Highway or Both?City\n",
      "Pick a brand car for analysis?Tesla\n",
      "\n",
      "\n",
      "{'Model X Long Range', 'Model Y Long Range AWD', 'Model S 100D', 'Model 3 Long Range', 'Model 3 Long Range AWD', 'Model 3 Standard Range', 'Model S Long Range', 'Model X Performance (20in Wheels)', 'Model X P100D', 'Model 3 Long Range Performance AWD (20in)', 'Model Y Performance AWD (21in Wheels)', 'Model 3 Long Range Performance AWD (18in)', 'Model S Standard Range', 'Model 3 Mid Range', 'Model S Performance (19in Wheels)', 'Model S 75D', 'Model 3 Long Range AWD Performance', 'Model X Performance (22in Wheels)', 'Model 3 Long Range Performance AWD (19in)', 'Model X Long Range Plus', 'Model 3 Standard Range Plus', 'Model 3 Performance AWD', 'Model X Standard Range', 'Model Y Performance AWD', 'Model X 100D', 'Model X 75D', 'Model S Long Range Plus', 'Model S P100D', 'Model S Performance (21in Wheels)'}\n",
      "\n",
      "\n",
      "Pick a model for your Tesla!Model S Performance (21in Wheels)\n",
      "Do you want to pick another car?(Y) or (N)Y\n",
      "Pick a brand car for analysis?Tesla\n",
      "\n",
      "\n",
      "{'Model X Long Range', 'Model Y Long Range AWD', 'Model S 100D', 'Model 3 Long Range', 'Model 3 Long Range AWD', 'Model 3 Standard Range', 'Model S Long Range', 'Model X Performance (20in Wheels)', 'Model X P100D', 'Model 3 Long Range Performance AWD (20in)', 'Model Y Performance AWD (21in Wheels)', 'Model 3 Long Range Performance AWD (18in)', 'Model S Standard Range', 'Model 3 Mid Range', 'Model S Performance (19in Wheels)', 'Model S 75D', 'Model 3 Long Range AWD Performance', 'Model X Performance (22in Wheels)', 'Model 3 Long Range Performance AWD (19in)', 'Model X Long Range Plus', 'Model 3 Standard Range Plus', 'Model 3 Performance AWD', 'Model X Standard Range', 'Model Y Performance AWD', 'Model X 100D', 'Model X 75D', 'Model S Long Range Plus', 'Model S P100D', 'Model S Performance (21in Wheels)'}\n",
      "\n",
      "\n",
      "Pick a model for your Tesla!Model X 100D\n",
      "Do you want to pick another car?(Y) or (N)Y\n",
      "Pick a brand car for analysis?Tesla\n",
      "\n",
      "\n",
      ...
      "\n",
      "\n",
      "Pick a model for your Tesla!Model S 75D\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "  <tbody>\n",
       "    <tr>\n",
       "      <th>Tesla Model S Performance (21in Wheels)</th>\n",
       "      <td>157.997794</td>\n",
       "      <td>100.764701</td>\n",
       "      <td>177.808455</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>Tesla Model X 100D</th>\n",
       "      <td>172.790172</td>\n",
       "      <td>107.569992</td>\n",
       "      <td>195.365482</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th>Tesla Model S 75D</th>\n",
       "      <td>154.189006</td>\n",
       "      <td>99.012453</td>\n",
       "      <td>173.287816</td>\n",
       "    </tr>\n",
      ...
      "text/plain": [
       ...
       "Tesla Model S Performance (21in Wheels)  157.997794  100.764701  177.808455\n",
       "Tesla Model X 100D                       172.790172  107.569992  195.365482\n",
       "Tesla Model S 75D                        154.189006   99.012453  173.287816"
      ]
     },
     "execution_count": 24,
     "metadata": {},
